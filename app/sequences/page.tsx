...
export default async function SequencesPage() {
  ...
  // Highest-scoring first, then capped. One query per qualified speaker
  // opened hundreds of connections against a 15-client pool.
  const SEQUENCE_LIMIT = 25;
  const qualifiedSpeakers = speakers
    .filter((s) => s.score >= 60)
