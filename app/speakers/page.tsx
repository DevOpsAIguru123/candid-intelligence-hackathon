...
export default async function SpeakersPage() {
  ...
  // Rendering every speaker took 12s once a conference with 1,228 people
  // landed. Highest scores first; the event workspace searches the full set.
  const ROW_LIMIT = 200;
  const visibleSpeakers = speakers.slice(0, ROW_LIMIT);
    ...
    <div className="page-stack">
      ...
      <section className="table-panel">
        <div className="section-heading">
          ...
          <span className="table-count">{visibleSpeakers.length} of {speakers.length}</span>
        </div>
